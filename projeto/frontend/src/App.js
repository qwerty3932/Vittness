                          ...
                          {editMode && (
                            <div style={{ background: COLORS.surface2, borderRadius: 8, padding: "10px 12px" }}>
                              ...
                              {replacingEx && replacingEx.dayIdx === idx && replacingEx.exIdx === j ? (
                                <div>
                                  <div style={{ fontSize: 11, color: COLORS.warning, fontWeight: 700, marginBottom: 6, letterSpacing: 1 }}>SUBSTITUIR POR:</div>
                                  ...
                                  <button onClick={() => setReplacingEx(null)} style={{ marginTop: 8, background: "none", border: "none", color: COLORS.textMuted, fontSize: 12, cursor: "pointer", fontFamily: "inherit" }}>✕ Cancelar</button>
                                </div>
                              ) : (
                                <>
